...
/**
 * struct shash_node_s - the node of hash table
 *
 * @key: The key, string
...
int hash_table_set(hash_table_t *Hd, const char *key, const char *value);

/* 4-hash_table_get.c */
char *hash_table_get(const hash_table_t *Hd, const char *key);

/* 5-hash_table_print.c */
void hash_table_print(const hash_table_t *Hd);

/* 6-hash_table_delete.c */
void hash_table_delete(hash_table_t *Hd);
